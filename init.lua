...
require('lazy').setup({
  -- * pending update notification in lualine
  checker = {
    enabled = true,
    notify = false,
  },
  ...
  --
  -- * default setting copied from gitsigns.nvim repo
  { 'tpope/vim-fugitive' },
  {
    ...
    config = function()
      require('gitsigns').setup {
        ...
        on_attach = function(bufnr)
          ...
          -- * use vim-fugitive's, it's better and not broken after second call
          ...
          map('n', '<leader>td', gitsigns.preview_hunk_inline, { desc = 'Toggle deleted hunk' })
  ...
  { -- Autocompletion
    ...
    opts = {
      ...
      completion = {
        ...
        -- In C++, when type words after '<', auto-completion from lsp somehow won't work.
        -- But we can use a workaround that put '<' into the block list of trigger characters, and this can actually solve the problem mentioned above!
        -- I think lsp may keep looking for completions of '<' character, and there is none, so nothing shows up.
